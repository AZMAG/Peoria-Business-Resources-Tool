...
define([
  ...
  "esri/geometry/Point",
], function (config, { view }, Draw, geometryEngine, Graphic, FeatureLayer, Point) {
  ...
  async function formSubmitted(e) {
    ...
    if (formValid) {
      ...
      addMissingBusiness(data, icon[0].files ? icon[0].files[0] : null);
      ...
      fetch(
        ...
        // "http://localhost:5001/email/peoria",
        {
          method: "POST",
          headers: {
